...
var WORD_DATA = {
  N5: [
    ...
    { k: "高い", r: "たかい", m: "高的、貴的" }, { k: "安い", r: "やすい", m: "便宜的" }, { k: "父", r: "ちち", m: "爸爸" },
    { k: "母", r: "はは", m: "媽媽" }, { k: "兄", r: "あに", m: "哥哥" }, { k: "姉", r: "あね", m: "姊姊" },
    { k: "弟", r: "おとうと", m: "弟弟" }, { k: "妹", r: "いもうと", m: "妹妹" }, { k: "祖父", r: "そふ", m: "爺爺" },
    { k: "祖母", r: "そぼ", m: "奶奶" }, { k: "子供", r: "こども", m: "小孩" }, { k: "赤ちゃん", r: "あかちゃん", m: "嬰兒" },
    { k: "夫", r: "おっと", m: "丈夫" }, { k: "妻", r: "つま", m: "妻子" }, { k: "兄弟", r: "きょうだい", m: "兄弟姊妹" },
    { k: "頭", r: "あたま", m: "頭" }, { k: "顔", r: "かお", m: "臉" }, { k: "目", r: "め", m: "眼睛" },
    { k: "耳", r: "みみ", m: "耳朵" }, { k: "口", r: "くち", m: "嘴巴" }, { k: "鼻", r: "はな", m: "鼻子" },
    { k: "手", r: "て", m: "手" }, { k: "足", r: "あし", m: "腳" }, { k: "体", r: "からだ", m: "身體" },
    { k: "髪", r: "かみ", m: "頭髮" }, { k: "赤", r: "あか", m: "紅色" }, { k: "青", r: "あお", m: "藍色" },
    { k: "白", r: "しろ", m: "白色" }, { k: "黒", r: "くろ", m: "黑色" }, { k: "黄色", r: "きいろ", m: "黃色" },
    { k: "緑", r: "みどり", m: "綠色" }, { k: "茶色", r: "ちゃいろ", m: "咖啡色" }, { k: "今", r: "いま", m: "現在" },
    { k: "今週", r: "こんしゅう", m: "這星期" }, { k: "来週", r: "らいしゅう", m: "下星期" }, { k: "先週", r: "せんしゅう", m: "上星期" },
    { k: "今月", r: "こんげつ", m: "這個月" }, { k: "来月", r: "らいげつ", m: "下個月" }, { k: "先月", r: "せんげつ", m: "上個月" },
    { k: "今年", r: "ことし", m: "今年" }, { k: "来年", r: "らいねん", m: "明年" }, { k: "去年", r: "きょねん", m: "去年" },
    { k: "毎日", r: "まいにち", m: "每天" }, { k: "毎週", r: "まいしゅう", m: "每星期" }, { k: "毎月", r: "まいつき", m: "每月" },
    { k: "毎年", r: "まいとし", m: "每年" }, { k: "午前", r: "ごぜん", m: "上午" }, { k: "午後", r: "ごご", m: "下午" },
    { k: "週末", r: "しゅうまつ", m: "週末" }, { k: "誕生日", r: "たんじょうび", m: "生日" }, { k: "月曜日", r: "げつようび", m: "星期一" },
    { k: "火曜日", r: "かようび", m: "星期二" }, { k: "水曜日", r: "すいようび", m: "星期三" }, { k: "木曜日", r: "もくようび", m: "星期四" },
    { k: "金曜日", r: "きんようび", m: "星期五" }, { k: "土曜日", r: "どようび", m: "星期六" }, { k: "日曜日", r: "にちようび", m: "星期日" },
    { k: "教室", r: "きょうしつ", m: "教室" }, { k: "図書館", r: "としょかん", m: "圖書館" }, { k: "公園", r: "こうえん", m: "公園" },
    { k: "銀行", r: "ぎんこう", m: "銀行" }, { k: "郵便局", r: "ゆうびんきょく", m: "郵局" }, { k: "店", r: "みせ", m: "商店" },
    { k: "デパート", r: "デパート", m: "百貨公司" }, { k: "スーパー", r: "スーパー", m: "超市" }, { k: "レストラン", r: "レストラン", m: "餐廳" },
    { k: "喫茶店", r: "きっさてん", m: "咖啡廳" }, { k: "ホテル", r: "ホテル", m: "飯店" }, { k: "空港", r: "くうこう", m: "機場" },
    { k: "神社", r: "じんじゃ", m: "神社" }, { k: "お寺", r: "おてら", m: "寺廟" }, { k: "美術館", r: "びじゅつかん", m: "美術館" },
    { k: "動物園", r: "どうぶつえん", m: "動物園" }, { k: "映画館", r: "えいがかん", m: "電影院" }, { k: "プール", r: "プール", m: "游泳池" },
    { k: "トイレ", r: "トイレ", m: "廁所" }, { k: "台所", r: "だいどころ", m: "廚房" }, { k: "部屋", r: "へや", m: "房間" },
    { k: "庭", r: "にわ", m: "庭院" }, { k: "玄関", r: "げんかん", m: "玄關" }, { k: "階段", r: "かいだん", m: "樓梯" },
    { k: "エレベーター", r: "エレベーター", m: "電梯" }, { k: "机", r: "つくえ", m: "書桌" }, { k: "椅子", r: "いす", m: "椅子" },
    { k: "黒板", r: "こくばん", m: "黑板" }, { k: "鉛筆", r: "えんぴつ", m: "鉛筆" }, { k: "ボールペン", r: "ボールペン", m: "原子筆" },
    { k: "ノート", r: "ノート", m: "筆記本" }, { k: "かばん", r: "かばん", m: "包包" }, { k: "傘", r: "かさ", m: "雨傘" },
    { k: "時計", r: "とけい", m: "時鐘、手錶" }, { k: "眼鏡", r: "めがね", m: "眼鏡" }, { k: "財布", r: "さいふ", m: "錢包" },
    { k: "鍵", r: "かぎ", m: "鑰匙" }, { k: "切手", r: "きって", m: "郵票" }, { k: "手紙", r: "てがみ", m: "信" },
    { k: "箱", r: "はこ", m: "箱子" }, { k: "袋", r: "ふくろ", m: "袋子" }, { k: "カメラ", r: "カメラ", m: "相機" },
    { k: "テレビ", r: "テレビ", m: "電視" }, { k: "ラジオ", r: "ラジオ", m: "收音機" }, { k: "電話", r: "でんわ", m: "電話" },
    { k: "携帯電話", r: "けいたいでんわ", m: "手機" }, { k: "パソコン", r: "パソコン", m: "電腦" }, { k: "冷蔵庫", r: "れいぞうこ", m: "冰箱" },
    { k: "洗濯機", r: "せんたくき", m: "洗衣機" }, { k: "石鹸", r: "せっけん", m: "肥皂" }, { k: "米", r: "こめ", m: "米" },
    { k: "パン", r: "パン", m: "麵包" }, { k: "肉", r: "にく", m: "肉" }, { k: "野菜", r: "やさい", m: "蔬菜" },
    { k: "果物", r: "くだもの", m: "水果" }, { k: "卵", r: "たまご", m: "蛋" }, { k: "牛乳", r: "ぎゅうにゅう", m: "牛奶" },
    { k: "お茶", r: "おちゃ", m: "茶" }, { k: "コーヒー", r: "コーヒー", m: "咖啡" }, { k: "ジュース", r: "ジュース", m: "果汁" },
    { k: "砂糖", r: "さとう", m: "糖" }, { k: "塩", r: "しお", m: "鹽" }, { k: "醤油", r: "しょうゆ", m: "醬油" },
    { k: "朝ご飯", r: "あさごはん", m: "早餐" }, { k: "昼ご飯", r: "ひるごはん", m: "午餐" }, { k: "晩ご飯", r: "ばんごはん", m: "晚餐" },
    { k: "弁当", r: "べんとう", m: "便當" }, { k: "お菓子", r: "おかし", m: "點心" }, { k: "ケーキ", r: "ケーキ", m: "蛋糕" },
    { k: "料理", r: "りょうり", m: "料理" }, { k: "服", r: "ふく", m: "衣服" }, { k: "シャツ", r: "シャツ", m: "襯衫" },
    { k: "ズボン", r: "ズボン", m: "褲子" }, { k: "靴", r: "くつ", m: "鞋子" }, { k: "靴下", r: "くつした", m: "襪子" },
    { k: "帽子", r: "ぼうし", m: "帽子" }, { k: "手袋", r: "てぶくろ", m: "手套" }, { k: "ネクタイ", r: "ネクタイ", m: "領帶" },
    { k: "スカート", r: "スカート", m: "裙子" }, { k: "行く", r: "いく", m: "去" }, { k: "来る", r: "くる", m: "來" },
    { k: "帰る", r: "かえる", m: "回去" }, { k: "食べる", r: "たべる", m: "吃" }, { k: "飲む", r: "のむ", m: "喝" },
    { k: "見る", r: "みる", m: "看" }, { k: "聞く", r: "きく", m: "聽、問" }, { k: "話す", r: "はなす", m: "說" },
    { k: "読む", r: "よむ", m: "讀" }, { k: "書く", r: "かく", m: "寫" }, { k: "買う", r: "かう", m: "買" },
    { k: "売る", r: "うる", m: "賣" }, { k: "起きる", r: "おきる", m: "起床" }, { k: "寝る", r: "ねる", m: "睡覺" },
    { k: "働く", r: "はたらく", m: "工作" }, { k: "休む", r: "やすむ", m: "休息" }, { k: "教える", r: "おしえる", m: "教" },
    { k: "分かる", r: "わかる", m: "明白" }, { k: "忘れる", r: "わすれる", m: "忘記" }, { k: "始まる", r: "はじまる", m: "開始" },
    { k: "終わる", r: "おわる", m: "結束" }, { k: "洗う", r: "あらう", m: "洗" }
  ],
  N4: [
    ...
    { k: "緊張", r: "きんちょう", m: "緊張" }, { k: "選ぶ", r: "えらぶ", m: "選擇" }, { k: "決める", r: "きめる", m: "決定" },
    { k: "比べる", r: "くらべる", m: "比較" }, { k: "続ける", r: "つづける", m: "繼續" }, { k: "変える", r: "かえる", m: "改變（他動詞）" },
    { k: "変わる", r: "かわる", m: "改變（自動詞）" }, { k: "増える", r: "ふえる", m: "增加" }, { k: "減る", r: "へる", m: "減少" },
    { k: "上がる", r: "あがる", m: "上升" }, { k: "下がる", r: "さがる", m: "下降" }, { k: "上げる", r: "あげる", m: "提高" },
    { k: "下げる", r: "さげる", m: "降低" }, { k: "集める", r: "あつめる", m: "收集" }, { k: "集まる", r: "あつまる", m: "聚集" },
    { k: "育てる", r: "そだてる", m: "養育" }, { k: "育つ", r: "そだつ", m: "成長" }, { k: "運ぶ", r: "はこぶ", m: "搬運" },
    { k: "届ける", r: "とどける", m: "送達" }, { k: "届く", r: "とどく", m: "送到" }, { k: "渡す", r: "わたす", m: "交給" },
    { k: "渡る", r: "わたる", m: "穿越" }, { k: "通る", r: "とおる", m: "經過" }, { k: "通う", r: "かよう", m: "往返、通勤" },
    { k: "慣れる", r: "なれる", m: "習慣於" }, { k: "気づく", r: "きづく", m: "注意到" }, { k: "感じる", r: "かんじる", m: "感覺" },
    { k: "考える", r: "かんがえる", m: "思考" }, { k: "信じる", r: "しんじる", m: "相信" }, { k: "疑う", r: "うたがう", m: "懷疑" },
    { k: "争う", r: "あらそう", m: "爭執" }, { k: "戦う", r: "たたかう", m: "戰鬥" }, { k: "守る", r: "まもる", m: "保護" },
    { k: "助ける", r: "たすける", m: "幫助" }, { k: "断る", r: "ことわる", m: "拒絕" }, { k: "謝る", r: "あやまる", m: "道歉" },
    { k: "褒める", r: "ほめる", m: "稱讚" }, { k: "叱る", r: "しかる", m: "責罵" }, { k: "泣く", r: "なく", m: "哭" },
    { k: "笑う", r: "わらう", m: "笑" }, { k: "怒る", r: "おこる", m: "生氣" }, { k: "驚く", r: "おどろく", m: "驚訝" },
    { k: "悩む", r: "なやむ", m: "煩惱" }, { k: "困る", r: "こまる", m: "困擾" }, { k: "喜ぶ", r: "よろこぶ", m: "高興" },
    { k: "悲しむ", r: "かなしむ", m: "悲傷" }, { k: "期待する", r: "きたいする", m: "期待" }, { k: "想像する", r: "そうぞうする", m: "想像" },
    { k: "発表する", r: "はっぴょうする", m: "發表" }, { k: "提出する", r: "ていしゅつする", m: "提出" }, { k: "完成する", r: "かんせいする", m: "完成" },
    { k: "成功する", r: "せいこうする", m: "成功" }, { k: "失敗する", r: "しっぱいする", m: "失敗" }, { k: "挑戦する", r: "ちょうせんする", m: "挑戰" },
    { k: "努力する", r: "どりょくする", m: "努力" }, { k: "便利", r: "べんり", m: "方便" }, { k: "不便", r: "ふべん", m: "不方便" },
    { k: "親切", r: "しんせつ", m: "親切" }, { k: "熱心", r: "ねっしん", m: "熱心" }, { k: "真面目", r: "まじめ", m: "認真" },
    { k: "素直", r: "すなお", m: "坦率" }, { k: "簡単", r: "かんたん", m: "簡單" }, { k: "複雑", r: "ふくざつ", m: "複雜" },
    { k: "十分", r: "じゅうぶん", m: "充分" }, { k: "大切", r: "たいせつ", m: "重要" }, { k: "必要", r: "ひつよう", m: "必要" },
    { k: "自由", r: "じゆう", m: "自由" }, { k: "特別", r: "とくべつ", m: "特別" }, { k: "普通", r: "ふつう", m: "普通" },
    { k: "一般", r: "いっぱん", m: "一般" }, { k: "立派", r: "りっぱ", m: "出色" }, { k: "有名", r: "ゆうめい", m: "有名" },
    { k: "上手", r: "じょうず", m: "擅長" }, { k: "下手", r: "へた", m: "不擅長" }, { k: "苦手", r: "にがて", m: "不拿手" },
    { k: "得意", r: "とくい", m: "拿手" }, { k: "残念", r: "ざんねん", m: "遺憾" }, { k: "大丈夫", r: "だいじょうぶ", m: "沒關係" },
    { k: "邪魔", r: "じゃま", m: "妨礙" }, { k: "無理", r: "むり", m: "勉強、不可能" }, { k: "楽", r: "らく", m: "輕鬆" },
    { k: "静か", r: "しずか", m: "安靜" }, { k: "恐ろしい", r: "おそろしい", m: "可怕" }, { k: "珍しい", r: "めずらしい", m: "稀奇" },
    { k: "眩しい", r: "まぶしい", m: "刺眼" }, { k: "深い", r: "ふかい", m: "深" }, { k: "浅い", r: "あさい", m: "淺" },
    { k: "厚い", r: "あつい", m: "厚" }, { k: "薄い", r: "うすい", m: "薄" }, { k: "硬い", r: "かたい", m: "硬" },
    { k: "柔らかい", r: "やわらかい", m: "軟" }, { k: "苦い", r: "にがい", m: "苦" }, { k: "酸っぱい", r: "すっぱい", m: "酸" },
    { k: "辛い", r: "からい", m: "辣、痛苦" }, { k: "甘い", r: "あまい", m: "甜" }, { k: "気候", r: "きこう", m: "氣候" },
    { k: "季節", r: "きせつ", m: "季節" }, { k: "春", r: "はる", m: "春天" }, { k: "夏", r: "なつ", m: "夏天" },
    { k: "秋", r: "あき", m: "秋天" }, { k: "冬", r: "ふゆ", m: "冬天" }, { k: "気温", r: "きおん", m: "氣溫" },
    { k: "湿度", r: "しつど", m: "濕度" }, { k: "晴れ", r: "はれ", m: "晴天" }, { k: "曇り", r: "くもり", m: "陰天" },
    { k: "雪", r: "ゆき", m: "雪" }, { k: "風", r: "かぜ", m: "風" }, { k: "波", r: "なみ", m: "浪" },
    { k: "太陽", r: "たいよう", m: "太陽" }, { k: "月", r: "つき", m: "月亮" }, { k: "星", r: "ほし", m: "星星" },
    { k: "空気", r: "くうき", m: "空氣" }, { k: "自然", r: "しぜん", m: "自然" }, { k: "社会", r: "しゃかい", m: "社會" },
    { k: "企業", r: "きぎょう", m: "企業" }, { k: "職業", r: "しょくぎょう", m: "職業" }, { k: "給料", r: "きゅうりょう", m: "薪水" },
    { k: "会議", r: "かいぎ", m: "會議" }, { k: "部長", r: "ぶちょう", m: "部長" }, { k: "課長", r: "かちょう", m: "課長" },
    { k: "社長", r: "しゃちょう", m: "社長" }, { k: "同僚", r: "どうりょう", m: "同事" }, { k: "部下", r: "ぶか", m: "部屬" },
    { k: "上司", r: "じょうし", m: "上司" }, { k: "出張", r: "しゅっちょう", m: "出差" }, { k: "残業", r: "ざんぎょう", m: "加班" },
    { k: "休憩", r: "きゅうけい", m: "休息" }, { k: "昇進", r: "しょうしん", m: "升遷" }, { k: "健康", r: "けんこう", m: "健康" },
    { k: "病気", r: "びょうき", m: "生病" }, { k: "風邪", r: "かぜ", m: "感冒" }, { k: "熱", r: "ねつ", m: "發燒" },
    { k: "怪我", r: "けが", m: "受傷" }, { k: "薬", r: "くすり", m: "藥" }, { k: "治る", r: "なおる", m: "治癒" },
    { k: "治す", r: "なおす", m: "治療" }, { k: "医者", r: "いしゃ", m: "醫生" }, { k: "看護師", r: "かんごし", m: "護士" },
    { k: "注射", r: "ちゅうしゃ", m: "打針" }, { k: "手術", r: "しゅじゅつ", m: "手術" }, { k: "検査", r: "けんさ", m: "檢查" },
    { k: "値段", r: "ねだん", m: "價格" }, { k: "料金", r: "りょうきん", m: "費用" }, { k: "税金", r: "ぜいきん", m: "稅金" },
    { k: "貯金", r: "ちょきん", m: "存款" }, { k: "財産", r: "ざいさん", m: "財產" }, { k: "借金", r: "しゃっきん", m: "借款" },
    { k: "割引", r: "わりびき", m: "折扣" }, { k: "売り場", r: "うりば", m: "賣場" }, { k: "レジ", r: "レジ", m: "收銀台" },
    { k: "現金", r: "げんきん", m: "現金" }, { k: "クレジットカード", r: "クレジットカード", m: "信用卡" }, { k: "以上", r: "いじょう", m: "以上" },
    { k: "以下", r: "いか", m: "以下" }, { k: "以内", r: "いない", m: "以內" }, { k: "以外", r: "いがい", m: "以外" },
    { k: "全部", r: "ぜんぶ", m: "全部" }, { k: "一部", r: "いちぶ", m: "一部分" }, { k: "大部分", r: "だいぶぶん", m: "大部分" },
    { k: "半分", r: "はんぶん", m: "一半" }, { k: "平均", r: "へいきん", m: "平均" }
  ],
  N3: [
